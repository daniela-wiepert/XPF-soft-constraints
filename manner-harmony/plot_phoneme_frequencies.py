...
for lang_code in lang_codes: 
    ...
    with open('phoneme_frequencies/' + lang_code + '_generated_frequencies.json', 'r', encoding='utf8') as fin:
        generated = json.load(fin)

    with open('phoneme_frequencies/' + lang_code + '_natural_frequencies.json', 'r', encoding='utf8') as fin:
...
plt.tight_layout()
plt.savefig("frequency_plots/all_subplots.png")
