...
def generate_phoneme(model, wordlen=10, context='', n=4, current_prob=None):
    context = context.split(" ")
    n_context = context[-n:]
...
def generate_lexicon(model, wordlen=10, context="", n=4, current_prob=None):
    '''
...
def main():
    ...
    for lang_code in lang_codes:
        ...
        generate_lexicon(model,wordlen = 10)
