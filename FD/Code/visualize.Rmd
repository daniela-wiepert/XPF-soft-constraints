...
setwd("/Users/danielawiepert/Documents/GitHub/thesis-project/Code")
```
...
```{r read}
lang_codes <- read.csv("Data/filtered_codes25000_3.tsv", sep='\t', header=F)
...
```{r reg-plots}
ggsave(file="Data/final_voiced-filtered3.pdf", gridExtra::arrangeGrob(grobs=final_voiced_obstruents_plots[1:16], labels=lang_codes$code), width=12, height=8)
ggsave(file="Data/final_voiced_2-filtered3.pdf", gridExtra::arrangeGrob(grobs=final_voiced_obstruents_plots[17:32], labels=lang_codes$code), width=12, height=8)
ggsave(file="Data/final_voiced_3-filtered3.pdf", gridExtra::arrangeGrob(grobs=final_voiced_obstruents_plots[33:45], labels=lang_codes$code), width=12, height=8)
...
write.csv(percentiles, "Data/percentiles-filtered3.csv")
...
ggsave(final_voiced_percentile_density, file="Data/final_voiced_percentile_density-filtered3.pdf", height=4, width=8)
