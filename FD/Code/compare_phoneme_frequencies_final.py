...
def main():
    ...
    for lang in split_list:
        ...
        for wd in generated_words:
            wd = wd.split(" ")
            generated_phoneme_count[wd[-2]] += 1
        ...
        with open('Data/phoneme_frequencies/' + lang + '_generated_frequencies_final.json', 'w', encoding='utf8') as fout:
            json.dump(generated_phoneme_freq, fout, ensure_ascii=False)
        with open('Data/phoneme_frequencies/' + lang + '_generated_counts_final.json', 'w', encoding='utf8') as fout:
            json.dump(generated_phoneme_count, fout, ensure_ascii=False)
        with open('Data/phoneme_frequencies/' + lang + '_natural_frequencies_final.json', 'w', encoding='utf8') as fout:
            json.dump(natural_phoneme_freq, fout, ensure_ascii=False)
        with open('Data/phoneme_frequencies/' + lang + '_natural_counts_final.json', 'w', encoding='utf8') as fout:
